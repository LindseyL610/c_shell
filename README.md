...
The p3testscript file can be used to test the smallsh script. To run it, place it in the same directory as the compiled shell, chmod it (chmod +x ./p3testscript) and run this command from a bash prompt:
